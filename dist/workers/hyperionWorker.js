...
export class HyperionWorker {
        ...
        process.on('message', (msg) => {
            switch (msg.event) {
                case 'request_v8_heap_stats': {
                    const report = v8.getHeapStatistics();
    ...
    anyFromDeltaCode(delta) {
        return this.chain + '::' + delta.code + '::*';
    }
    anyFromDeltaTable(delta) {
