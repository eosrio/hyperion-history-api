...
async function checkRabbit(fastify) {
    try {
...
async function checkNodeos(fastify) {
...
async function checkElastic(fastify) {
    try {
...
async function getHealthQuery(fastify, request) {
    let response = {
...
export function healthHandler(fastify, route) {
