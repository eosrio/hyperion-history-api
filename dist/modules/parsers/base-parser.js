...
export function timedFunction(enable, method) {
    if (enable) {
...
export class BaseParser {
    ...
    extendFirstAction(worker, action, trx_data, full_trace, usageIncluded) {
    ...
    async reinterpretActionData(act) {
    ...
    async deserializeActionData(worker, action, trx_data) {
        let act = action.act;
